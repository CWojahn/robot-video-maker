...
async function robot(){
	...
	async function fetchGoogleAndReturnImageLinks(query){
		const response = await customSearch.cse.list({
			...
			q: query,
			searchType: 'image',
			imgSize: 'huge', //icon, small, medium, large, xlarge, xxlarge, and huge
			rights: 'cc_sharealike',  //cc_publicdomain, cc_attribute, cc_sharealike, cc_noncommercial, cc_nonderived and combinations of these
			num: 2
		})	
